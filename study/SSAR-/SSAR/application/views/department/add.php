...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <?php echo form_open('department/add', ['id' => 'form']);?>
            
            <input type="text" class="form-control mt-4 <?= form_error('name') ? 'is-invalid':'' ?>" name="name" value="<?php echo set_value('name'); ?>"  placeholder="Department">
